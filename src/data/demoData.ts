...
export const DEMO_DOSSIERS: DossierCandidature[] = [
  {
    ...
    form: {
      ...
      departement: 'Borgou',
      commune: 'Parakou',
      domaines: ['SDR (Surveillance-Documentation-Rapportage)'],
  ...
  },
  {
    ...
    form: {
      ...
      departement: 'Littoral',
      commune: 'Cotonou',
      domaines: ['Sensibilisation Droits Humains'],
  ...
  },
  {
    ...
    form: {
      ...
      departement: 'Atacora',
      commune: 'Natitingou',
      domaines: ['Plaidoyer DESC (Droits Économiques, Sociaux et Culturels)'],
