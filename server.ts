...
export async function createApp(): Promise<Express> {
  ...
  // --- VITE SPA SERVING & ROUTE FALLBACKS ---
...
// --- START HTTP SERVER (local dev & standalone Node hosting) ---
// On Vercel, this module is imported by api/index.ts as a serverless function,
// so we skip listening and let Vercel invoke the Express app per-request.
